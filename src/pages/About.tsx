  ...
  return (
    <PageVideoBackground>
      ...
      <main className="flex-1 py-8 sm:py-12 lg:py-16 pb-16">
        <article className="liquid-glass border border-[#5A6975]/30 rounded-2xl px-5 sm:px-8 lg:px-10 py-8 sm:py-12 max-w-3xl mx-auto">
          <header className="mb-10 sm:mb-12">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-3 leading-tight">
              About Us
            </h1>
            <p className="text-[#BABEBC] text-base leading-relaxed">
              Two apps, one purpose: reliable water delivery for homes, businesses, and communities.
            </p>
          </header>

          <div className="space-y-12 sm:space-y-16 text-gray-300 text-base leading-7 max-w-none">
            <section id="admin-app" className="scroll-mt-8">
              <h2 className="text-xl sm:text-2xl font-semibold text-white mb-2">
                Water Tanker — Admin App
              </h2>
              <p className="text-lg font-medium text-[#8A9399] mb-6">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 mt-8">
                Our Mission
              </h3>
              <p className="leading-relaxed mb-4">
              ...
              <ul className="list-disc pl-5 sm:pl-6 space-y-2 mb-4 leading-7 marker:text-[#5A6975]">
                <li>
                  <strong className="text-[#BABEBC]">Fast Delivery</strong> — Water delivered to
                  your doorstep within hours of booking.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">Verified Suppliers</strong> — All our tanker
                  operators are screened and certified for water quality and safety.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">Real-Time Tracking</strong> — Know exactly
                  where your tanker is at all times.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">Transparent Pricing</strong> — No hidden
                  charges. Pay only for what you order.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">24/7 Support</strong> — Our team is always
            ...
            <section id="customer-app" className="scroll-mt-8">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 mt-2">
                Why We Built This
              </h3>
              <p className="leading-relaxed mb-4">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-white mb-3">What We Offer</h3>
              <ul className="list-disc pl-5 sm:pl-6 space-y-2 mb-8 leading-7 marker:text-[#5A6975]">
                <li>
                  <strong className="text-[#BABEBC]">Instant &amp; Scheduled Bookings</strong> —
                  Book a tanker right now or plan ahead for the perfect delivery time.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">Real-Time Tracking</strong> — Know exactly
                  where your tanker is and when it will arrive.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">Transparent Pricing</strong> — Distance-based
                  pricing with no hidden charges. See the full breakdown before you confirm.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">Society Accounts</strong> — Dedicated login
                  and trip management for housing societies with bulk delivery needs.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">Secure Payments</strong> — Seamless payments
                  powered by PhonePe, with a full subscription plan for regular users.
                </li>
                <li>
                  <strong className="text-[#BABEBC]">Multiple Saved Addresses</strong> — Manage
                  deliveries across different locations with ease.
                </li>
              </ul>
