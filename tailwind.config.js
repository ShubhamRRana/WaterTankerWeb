...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'fluid-hero': ['clamp(1.125rem, 6vw, 4.5rem)', { lineHeight: '1.1' }],
        'fluid-lead': ['clamp(1rem, 1.5vw + 0.875rem, 1.125rem)', { lineHeight: '1.6' }],
        'fluid-tagline': ['clamp(1.125rem, 2vw + 0.875rem, 1.5rem)', { lineHeight: '1.35' }],
        'fluid-card-title': ['clamp(1.0625rem, 1.25vw + 0.875rem, 1.125rem)', { lineHeight: '1.3' }],
        'fluid-card-desc': ['0.8125rem', { lineHeight: '1.375' }],
